function hollywoodList(){
	...
	list.push({incompWord: "__E _A__ __I_H_ _I_E_",
	...
	list.push({incompWord: "A_I__ I_ _O__E__A__",
	...
	list.push({incompWord: "__E _A _I_C_ _O_E",
		compWord: "THE DA VINCI CODE"});
		
	list.push({incompWord: "_A__ O_ __E __A__T O_ __E ___S",
	...
	list.push({incompWord: "I__E__I_N",
		compWord: "INCEPTION"});
		
	list.push({incompWord: "__E _A__I_",
		compWord: "THE MATRIX"});
	
	list.push({incompWord: "_E_E_ _A_U__I",
		compWord: "SEVEN SAMURAI"});
		
	list.push({incompWord: "_I_E I_ _E_U___U_",
	...
	list.push({incompWord: "__A_I__O_",
		compWord: "GLADIATOR"});
	...
	list.push({incompWord: "_H_ __E_T _I__A_O_",
	...
	list.push({incompWord: "_H_ __E_T _S__P_",
		compWord: "THE GREAT ESCAPE"});
		
	list.push({incompWord: "_H_ _E__E_ _N __EI_ E_E_",
		compWord: "THE SECRET IN THEIR EYES"});
		
	list.push({incompWord: "_ _EA__I__L _I__",
		compWord: "A BEAUTIFUL MIND"});
		
	list.push({incompWord: "_O _O_N__Y _O_ O__ _E_",
		compWord: "NO COUNTRY FOR OLD MEN"});
		
	list.push({incompWord: "_O_ _O __AI_ _O_R __A_O_",
